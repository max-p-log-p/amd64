...
https://xfersh.syssec.org/SCJv1/CS6332.001-f21-Lab4-amd64.tar.bz2

Okay, here we go. First of all, sorry for the delays and here a few things that I want to clarify.

You only need to instrument fib.c for AMD64 and print out basic block profiling results (i.e., 4-2).

Unfortunately, I couldn’t fully verify the skeleton code for the extra assignment. Therefore, it can come with some parts are missing (especially from amd64_disasm.c) or not working as is. Please feel free to notify me on any unexpected errors or failures. I will have a look.

I will give you extra time to work on this. You can submit the assignment by sending me an email by this Sunday midnight.
Although you couldn’t finish it all the way, you can still send your work to me. I will have a look and give you partial credits.

I hope this make sense. Please let me know if you have any further questions.
